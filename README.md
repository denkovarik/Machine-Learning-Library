...
## Testing
Testing was only completed for the Perceptron and K Nearest Neighbors modules. You should be able to run the tests from any directory. You can run these tests by running the following commands from the project root directory.
```
cd testing/
./runTests.sh
```
